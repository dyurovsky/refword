...
\begin{figure}[tb]
	\center{\includegraphics[width=.5\textwidth]{figures/reflook_familiar.pdf}}
...
\begin{figure}[tb]
	\center{\includegraphics[width=.5\textwidth]{figures/soc_word_test.pdf}}
...
%Vocabulary continues to accelerate. We've suggested that one possible reason is continued increases in proficiency in social attention.
%
%Everything gets better in a graded way social is related to language
%
%Summary
%
%Broader implications about speed of processing. Domain general changes verses domain-specific changes (e.g. learning turn taking rates or something). 
%
%Autism isn't exclusively a social processing disorder. But this is some evidence that social processing deficits can cascade into language. Successesful kids are successful in the same way.
%
%
%limitations
%kinds of video--- E1and2 are "naturalistic" but still videos. Video deficit but also overhearing suff from Akhtar.
%Causal inference limitations on 1 and 2---studies and correlations
%Do away with some of this in E3 but lots of other stuff (e.g. gaze vs. hold vs. whatever)
%
%Artificially made the input environment different for every kid, but the real environment probably isn't. Possibly for the better.
